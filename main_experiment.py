# main_experiment.py
"""
Tests graph lifting and rewiring on graph classifiation/regression benchmarks.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["gcn", "gin", "rgcn", "rgin", "sgc", "sin", "cin", "cin++"],
    )
    parser.add_argument(
        "--samples",
        type=int,
    ...
    # * Set up grid search
    if len(command_args.models) == 0:
        raise ValueError("At least one model must be selected")
    args["model_name"] = grid_search(command_args.models)
